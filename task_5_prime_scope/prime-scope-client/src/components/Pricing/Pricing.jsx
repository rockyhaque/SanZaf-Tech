      ...
      <div className="flex flex-col md:flex-row md:transform md:scale-75 lg:scale-100 justify-center">
        <div className="border rounded-lg md:rounded-r-none text-center p-5 mx-auto md:mx-0 my-2 md:my-6 bg-gray-100 font-medium z-0 shadow-lg">
          ...
          <a href="#" target="_blank">
            <div className="bg-gradient-base border border-purple-600 hover:bg-white text-white hover:text-purple-600 font-bold uppercase text-xs mt-5 py-2 px-4 rounded cursor-pointer">
              Learn More
            </div>
          </a>
        </div>
        <div className="border-transparent rounded-lg text-center p-5 mx-auto md:mx-0 my-2 bg-gradient text-white font-medium z-0 shadow-lg">
          <div className="py-4">
            ...
            <hr />
            <a href="#" target="_blank">
              <div className="bg-white border border-white hover:bg-transparent text-purple-600 hover:text-white font-bold uppercase text-xs mt-5 py-2 mpx-4 rounded cursor-pointer">
                Learn More
              </div>
            </a>
          </div>
        ...
        <div className="border rounded-lg  md:rounded-l-none text-center p-5 mx-auto md:mx-0 my-2 md:my-6 bg-gray-100 font-medium z-0 shadow-lg">
          ...
          <hr />
          <a href="#" target="_blank">
            <div className="bg-gradient-base border border-purple-600 hover:bg-transparent text-white hover:text-purple-600 font-bold uppercase text-xs mt-5 py-2 px-4 rounded cursor-pointer">
              Learn More
            </div>
          </a>
        </div>
